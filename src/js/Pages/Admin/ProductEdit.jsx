            ...
            .get(`/api/admin/product/${id}/edit`)
              .then((res) => {
                ...
                setData({
                    ...
                    'fetured':  res.data.product.fetured,
                    'status':  res.data.product.status,
                    'price':  res.data.product.price,
                    'image':  res.data.product.image,
                    'cat_id':  res.data.product.cat_id,
                    'tag_id':  res.data.product.tag_id,
                  }); 
              })
              .catch((error) => {
                console.log(error);
    ...
    const submitHandle = (e) =>{
       ...
       // formData.append('slug',data.slug);
        ...
        axios.get("/sanctum/csrf-cookie").then((res) => {
            axios.post(`/api/admin/product/${id}`, formData)
            .then((res) => {
            ...
            <div className="card mb-4">
                ...
                <form onSubmit={submitHandle}>
                    ...
                    <label className="col-sm-2 col-form-label">Category</label>
                        <select className="form-control" onChange={inputHandle} name="cat_id" value={data.cat_id}>
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control" onChange={inputHandle} name="tag_id" value={data.tag_id}>
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control" onChange={inputHandle} name="fetured" value={data.fetured}>
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control" onChange={inputHandle} name="status" value={data.status}>
